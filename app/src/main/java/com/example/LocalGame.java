...
import com.example.actionMessage.EndTurnAction;
import com.example.actionMessage.GameAction;
import com.example.actionMessage.GameOverAction;
import com.example.actionMessage.MyNameIsAction;
import com.example.actionMessage.ReadyAction;
import com.example.actionMessage.TimerAction;
import com.example.infoMessage.BindGameInfo;
import com.example.infoMessage.GameOverInfo;
...
import com.example.infoMessage.StartGameInfo;
...
public abstract class LocalGame implements Game, Tickable {
    ...
    private void receiveMessage(Message msg) {
        if (msg.obj instanceof GameAction) { // ignore if not GameAction
            ...
            else if (action instanceof GameOverAction && gameStage == GameStage.GAME_OVER) {
